...
Tie::TkListbox - Access Tk::Listbox and similar widgets as arrays
...
=head1 SYNOPSIS
  ...
  tie @scr_ary  => 'Tie::TkListbox', $scroll;
  tie @list_ary => 'Tie::TkListbox', $listb;
...
The Tie::TkListbox module allows you to tie the contents of a Tk::Listbox
